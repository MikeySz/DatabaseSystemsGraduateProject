...
if(!isset($_COOKIE['customer']))
	die("Please login first.<br>
		<a href='CPS5740_p1.html' target=_self>Return to Project Phase 1 Homepage</a>");
...
#display Customer's Information
				#SQL query to retrieve customer's info
					...
					echo "<form action='customer_info_insert.php' method='post'>";
					...
					echo "<br><a href='customer_login.php' target=_self>Return to Customer Homepage</a>";
							#Return to Phase1 homepage  
					echo "<br><a href='CPS5740_p1.html' target=_self>Return to Project Phase 1 Homepage</a>";
echo "</body>";
echo "</HTML>";
mysqli_close($con);
