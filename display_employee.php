<?php
#Michael S.
#Displays the employee info found within the EMPLOYEE table in the CPS5740 DB.
...
#Else continue with the employee display program
	echo "The followin employee are in the database.";
	$query = "SELECT employee_id id, login,password, name, role  FROM EMPLOYEE";
